...
#To check non-defaulters to defaulters proportion in the data set.
...
#Data is asymentrical, our data almost 80 percent of non-defaulters
...
#For now to get_dummies for different categorical variables which effects loan_status
...
#Feature importance by information gain, this is to see which features are helping us more in determining defaulters
